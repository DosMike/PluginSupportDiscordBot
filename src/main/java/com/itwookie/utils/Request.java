...
public class Request {
    ...
    /** The user agent is a static property due to the fact that is not supposed to change throughout an application */
    ...
    public void setBodyParameter(String key, Object value) {
        paramsBody.put(key, value == null ? "" : value.toString());
    }
